...
(function ($, window, document, undefined) {
  ...
  Navigation.prototype.draw = function () {
    ...
    if (settings.dots) {
      difference =
        this._Resources.length - this._controls.$absolute.children().length;
      ...
      this._controls.$absolute
        .children()
        .eq($.inArray(this.current(), this._Resources))
        .addClass("active");
    }
  };
  ...
  Navigation.prototype.onTrigger = function (event) {
    ...
    event.page = {
      index: $.inArray(this.current(), this._Resources),
  ...
  Navigation.prototype.getPosition = function (successor) {
    ...
    if (settings.slideBy == "page") {
      position = $.inArray(this.current(), this._Resources);
      length = this._Resources.length;
      successor ? ++position : --position;
      position = this._Resources[((position % length) + length) % length].start;
    } else {
  ...
  Navigation.prototype.to = function (position, speed, standard) {
    ...
    if (!standard && this._Resources.length) {
      length = this._Resources.length;
      $.proxy(this._overrides.to, this._core)(
        this._Resources[((position % length) + length) % length].start,
        speed
      );
    } else {
